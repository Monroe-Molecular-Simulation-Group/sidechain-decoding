...
python -m scdecode.analysis_tools analyze_model "${resnames[$SLURM_ARRAY_TASK_ID]}" -r "${datadir}/${resnames[$SLURM_ARRAY_TASK_ID]}" -m "${modeldir}/${resnames[$SLURM_ARRAY_TASK_ID]}"
