...
datadir="${HOME}/Sidechain_Decoding/clean_pdbs"
savedir="${HOME}/Sidechain_Decoding/training_inputs"
...
python -m scdecode.unconditional gen_input ${datadir}/residue_modifications.json NPRO -r ${datadir} -s ${savedir}/NPRO --bat_atom_str @N,CA,C,H2,H3 > gen_inputs_NPRO.out 2>&1
